...
def parse_args():
    parser = argparse.ArgumentParser(description="Train GCN with hyperparameters")
...
def main():
    ...
    print("\n=== GCN Final Evaluation (Best Model) ===")
    ...
    out_path = os.path.join(save_dir, f"gcn_trial_{args.trial_id}.pt")
