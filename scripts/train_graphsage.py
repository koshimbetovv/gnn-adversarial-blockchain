...
def main():
    ...
    for epoch in range(1, CONFIG["training"]["epochs"] + 1):
        ...
        if epoch == 1 or (epoch % log_every == 0):
            ...
            test_metrics_mid = eval_split(model, data, "test")
            ...
            print(
                ...
                f"TEST:  P={test_metrics_mid['precision_pos']:.4f} R={test_metrics_mid['recall_pos']:.4f} "
                f"F1={test_metrics_mid['f1_pos']:.4f} (FraudPred={test_metrics_mid['fraud_predictions']})"
            )

    # Final test eval
    test_metrics = eval_split(model, data, "test")

    print("\n=== GraphSAGE Final Test Evaluation ===")
    ...
    print(f"  Acc={test_metrics['acc']:.4f} | P(pos)={test_metrics['precision_pos']:.4f} "
          f"R(pos)={test_metrics['recall_pos']:.4f} F1(pos)={test_metrics['f1_pos']:.4f}")
